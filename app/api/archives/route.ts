...
// ID du dossier des archives giliionot
const ARCHIVES_FOLDER_ID = '15wm0pKC-s4o7h46mzb6fqiqZWZwJ11wo';
...
export async function GET() {
  try {
    ...
    const items = await listFilesRecursive(driveService, ARCHIVES_FOLDER_ID);
