      ...
      <main className="container mx-auto px-4 py-8" dir="rtl">
        ...
        <footer className="mt-16 pt-8 border-t border-gray-200">
          <div className="max-w-4xl mx-auto text-center text-gray-600">
            <h3 className="text-lg font-semibold mb-2">כל השיעורים באתר של מורינו הגאון הרב אופיר יצחק מלכא שליט"א ראש בית הוראה הלכה למעשה ומחה"ס הליכות שבת ד"כ, הליכות ברכות ב"כ, הליכות מועד ד"כ והליכות שמיטה</h3>
            <p className="mb-4">
              השיעורים מגוונים בנושאים הלכתיים מרתקים ומחכימים.
            </p>
            <p className="text-sm mb-2">
              השיעורים מתעדכנים באופן שוטף, כל השיעורים זמינים להאזנה והורדה לזיכוי הרבים ללא מטרת רווח
            </p>
            <p className="text-xs">
              כל הזכויות שמורות
            </p>
