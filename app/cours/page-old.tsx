...
import { Clock, Folder, FolderOpen, RefreshCw, ChevronRight, ChevronDown, Music } from 'lucide-react';
...
const folderIcons: Record<string, string> = {
  'ברכות': '/shiour/ברכות_דרייב.png',
  'שבת': '/shiour/שבת__פה__דרייב.png',
  'שבת עיון': '/shiour/שיעורים בעיון_שבת__דרייב.png',
  'שיעורים בעיון': '/shiour/שיעורים בעיון_שבת__דרייב.png',
  'שיעורים הלכות המועדים': '/shiour/מועדים_דרייב.png',
  'איסור והיתר': '/shiour/איסור והיתר__דרייב.png',
  'שיעורים הלכות נדה -תשסט': '/shiour/נדה__דרייב.png',
  ...
  'שאלות ותשובות': '/shiour/שות רדיו__דרייב.png',
};
      ...
      <div className="max-w-4xl mx-auto space-y-2">
        {selectedMainFolder && Object.entries(groupedCourses)
          ...
          .map(([folder, folderCourses]) => {
            ...
            const displayName = isSubFolder ? folderParts[folderParts.length - 1] : folder;
              ...
              <div key={folder} className="border rounded-lg overflow-hidden">
                ...
                >
                  <div className="flex items-center gap-3">
                    {folderIcons[selectedMainFolder || ''] ? (
                      <img 
                        src={folderIcons[selectedMainFolder || '']} 
                        alt={selectedMainFolder || ''} 
