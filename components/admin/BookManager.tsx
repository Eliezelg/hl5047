...
const BookManager = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (currentBook.id) {
        formData.append('id', currentBook.id.toString());
      }
      ...
      formData.append('nedarimPlusLink', currentBook.nedarimPlusLink || '');
      formData.append('isNew', currentBook.isNew ? 'true' : 'false');
