  ...
  // ב
  {
    ...
    blessings: [
      ...
      },
      {
        ...
        firstBlessing: "שהכל",
        lastBlessing: "נפשות",
        description: "שיעור כזית בנפח לברכה אחרונה, במבה רגילה – 14 אחדים. במבה נוגט – 10 אחדים. במבה אדומה – 30 אחדים"
      },
      {
        name: "בננה",
        firstBlessing: "האדמה",
        lastBlessing: "נפשות",
        description: "אם בירך העץ עיין סימן רג סעיף ד"
      },
      {
        name: "בננה צ'יפס",
        firstBlessing: "האדמה",
        lastBlessing: "נפשות",
        description: "ממתק העשוי מבננה מיובשת"
      },
      {
        name: "בצל ירוק",
        firstBlessing: "אדמה",
