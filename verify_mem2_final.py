...
# Read source file (entries 351-700)
with open('/home/eli/Documents/hl5047/docs/mem muktzeh.ini', 'r', encoding='utf-8') as f:
    all_lines = f.readlines()
    source_lines = all_lines[350:]

# Read target file
with open('/home/eli/Documents/hl5047/data/muktzeh/letters/mem2.ts', 'r', encoding='utf-8') as f:
...
print(f"Source entries (lines 351-700): {len(source_entries)}")
...
critical_checks = [
    ("מכשיר שמע", "מלאכתו לאיסור"),
    ("מנורה", "מוקצה מחמת איסור"),
    ("מצלמה", "מלאכתו לאיסור"),
    ("מקרר", "מלאכתו לאיסור"),
]
...
print("\n" + "=" * 80)
print(f"SUMMARY: {len(target_entries)} total entries in mem2.ts")
print("=" * 80)
