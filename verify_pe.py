...
# Read source file
with open('/home/eli/Documents/hl5047/docs/pe muktze.ini', 'r', encoding='utf-8') as f:
    source_lines = f.readlines()

# Read target file
with open('/home/eli/Documents/hl5047/data/muktzeh/letters/pe.ts', 'r', encoding='utf-8') as f:
...
critical_checks = [
    ("פח אשפה עם אשפה", "מוקצה מחמת גופו"),
    ("פח אשפה ריק", "מלאכתו לאיסור"),
    ("פלאפון", "מוקצה מחמת חסרון כיס"),
    ("פירות העומדים לסחורה", "מותר"),
    ("פנקס ריק", "מוקצה מחמת חסרון כיס"),
]
...
splits = [
    "פאזל",
    "פורמייקה שנשברה",
    "פח אשפה ריק שלא ניתן לנקותו לחלוטין",
    "פח שהתרוקן בשבת",
    "פחית נרונית",
    "פחית שתיה ריקה",
    "פירות העומדים לסחורה ביו\"ט",
    "פקס שהגיע בשבת"
]
...
print("\n" + "=" * 80)
print(f"SUMMARY: {len(target_entries)} total entries in pe.ts")
print("=" * 80)
